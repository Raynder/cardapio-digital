<form class="form-horizontal" action="{{ route('perfil.update') }}" method="POST" id="form2">
    @csrf
    <div class="form-group row">
        <label for="empresa" class="col-sm-2 col-form-label">Empresa</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="empresa" name="empresa" value="{{ isset($user->cardapio) ? $user->cardapio : '' }}" placeholder="Digite o nome de seu comercio">
        </div>
    </div>
