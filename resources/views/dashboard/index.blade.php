        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 produto-item">
                    ...
                    <div class="caixa">
                        <svg onclick="Controle.finalizarPedido({{$pedido->id}})" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
                    ...
                    <div class="caixa">
                        <svg onclick="Controle.removerPedido({{$pedido->id}})" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
